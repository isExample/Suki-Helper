...
public class BfsReachStrategy implements AlgorithmStrategy {
    ...
    public void solve(SimulationContext context) {
        ...
        SearchState initialState = new SearchState(INITIAL_TICK, INITIAL_STAMINA, new ArrayList<>(), context.consumableBag());
        VisitedKey initialKey = new VisitedKey(INITIAL_TICK, INITIAL_STAMINA, context.consumableBag().snapshotRemains());
